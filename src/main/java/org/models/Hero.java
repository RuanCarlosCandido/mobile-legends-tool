...
public enum Hero {
	...
	AKAI(TANK, Arrays.asList(SHIELD, KNOCK_BACK)),
	...
	ATLAS(TANK, Arrays.asList(CROWD_CONTROL, ENDURANCE, SKILL_SUPPRESSION)),
	...
	BALMOND(SOLDIER, Arrays.asList(REAL_DAMAGE,SPLASH_DAMAGE)),
	...
	CHOU(DAMAGE, Arrays.asList(INVULNERABILITY, HIGH_MOBILITY, SKILL_SUPPRESSION)),
	...
	FARAMIS(SUPPORT, Arrays.asList(RESSURECTION, SPLASH_DAMAGE)),
	...
	GUINEVERE(JUNGLE, Arrays.asList(SKILL_SUPPRESSION, HIGH_MOBILITY, REGENERATION)),
	...
	MINSITTHAR(SUPPORT, Arrays.asList(SKILL_SUPPRESSION)),
	MYA(DAMAGE, Arrays.asList(REAP, CONTROL_IMMUNITY, SPLASH_DAMAGE)),
	MOSKOV(DAMAGE, Arrays.asList(REAP, CROWD_CONTROL)),
	NANA(MAGE, Arrays.asList(RESSURECTION, CROWD_CONTROL, SKILL_SUPPRESSION)),
