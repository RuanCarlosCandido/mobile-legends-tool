...
public enum Hero {
	...
	GUINEVERE(JUNGLE, Arrays.asList(HIGH_MOBILITY, CROWD_CONTROL, REGENERATION)),
	...
	MELISSA(JUNGLE, Arrays.asList(CROWD_CONTROL, SHIELD, INVULNERABILITY)),
	...
	SILVANNA(JUNGLE, Arrays.asList(REGENERATION, SHIELD, ENCAGE)),
	...
	YUZHONG(SOLDIER, Arrays.asList(ENDURANCE, REGENERATION, HIGH_MOBILITY)),
