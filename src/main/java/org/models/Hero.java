...
public enum Hero {
	...
	CHANGE(MAGE, Arrays.asList(LONG_RANGE, SPLASH_DAMAGE)),
	...
	LANCELOT(DAMAGE, Arrays.asList(INVULNERABILITY, HIGH_MOBILITY,SPLASH_DAMAGE)),
	...
	POPOL(SOLDIER, Arrays.asList(ENDURANCE, REAP,SUMMON)),
	...
	VEXANA(MAGE, Arrays.asList(LONG_RANGE,SUMMON)),
