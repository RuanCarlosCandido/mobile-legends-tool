...
public enum Hero {
	...
	BELERICK(TANK, Arrays.asList(REFLECTION,CROWD_CONTROL)),
	BENEDETA(DAMAGE, Arrays.asList(HIGH_MOBILITY, CONTROL_IMMUNITY, INVULNERABILITY)),
	...
	FRANCO(TANK, Arrays.asList(CROWD_CONTROL,LONG_RANGE)),
	FREYA(SOLDIER, Arrays.asList(ENDURANCE, SHIELD)),
	GATOTKACA(TANK, Arrays.asList(ENDURANCE, CROWD_CONTROL)),
	GLOO(TANK, Arrays.asList(ENDURANCE, CROWD_CONTROL, LONG_RANGE)),
	GORD(MAGE, Arrays.asList(REAL_DAMAGE)),
	GRANGER(DAMAGE, Arrays.asList(HIGH_MOBILITY)),
	GROCK(TANK, Arrays.asList(CONTROL_IMMUNITY, CROWD_CONTROL, ENDURANCE)),
	...
	HYLOS(TANK, Arrays.asList(ENDURANCE, CROWD_CONTROL, SPLASH_DAMAGE)),
	...
	KHUFRA(SOLDIER, Arrays.asList(HIGH_MOBILITY, ENCAGE)),
